...
var TableOfContentsTree = function TableOfContentsTree(_ref) {
  ...
  if (node === null || node === undefined) return React.createElement(React.Fragment, null);
  return React.createElement(React.Fragment, null, node.cleanText && React.createElement("li", null, React.createElement("a", {
    href: "#" + createIdForTableOfContentHeading(node.cleanText)
  }, node.cleanText)), node.children && node.children.length > 0 && React.createElement("ul", null, node.children.map(function (value) {
    return React.createElement(TableOfContentsTree, {
      key: value.cleanText,
      node: value
    });
  })));
...
var TableOfContents = function TableOfContents(_ref2) {
  ...
  return React.createElement("div", null, React.createElement("div", null, tableOfContentsRoot !== undefined && React.createElement(TableOfContentsTree, {
